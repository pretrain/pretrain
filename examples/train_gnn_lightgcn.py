...
from src.models.gnn_lightgcn import LightGCNEngine
...
def parse_args():
    """ Parse args from command line
        ...
        Returns:
            args object.
    """
    parser = argparse.ArgumentParser(description="Run GNN_lightgcn..")
    parser.add_argument(
        "--config_file",
        nargs="?",
        type=str,
        default="../configs/gnn_lightgcn_default.json",
...
if __name__ == "__main__":
    ...
    lightgcn = LightGCN_train(config)
    lightgcn.train()
