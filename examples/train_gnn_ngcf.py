...
from src.models.gnn_ngcf import NGCFEngine
...
def parse_args():
    """ Parse args from command line
        ...
        Returns:
            args object.
    """
    parser = argparse.ArgumentParser(description="Run GNN-NGCF..")
    parser.add_argument(
        "--config_file",
        nargs="?",
        type=str,
        default="../configs/gnn_ngcf_default.json",
