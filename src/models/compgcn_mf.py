...
class MFEngine(Engine):
    ...
    def load_pretrain_weights(self):
        ...
        self.model.user_emb.weight.data = ua_embeddings.data
        self.model.item_emb.weight.data = ia_embeddings.data

        self.model.user_bias.weight.data = loaded_model.user_bias.weight.data
        self.model.item_bias.weight.data = loaded_model.item_bias.weight.data
        self.model.global_bias.data.fill_(loaded_model.global_bias.data.item())
