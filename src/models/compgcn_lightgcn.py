...
class LightGCNEngine(Engine):
    # A class includes train an epoch and train a batch of LightGCN

    def __init__(self, config):
        self.config = config
        self.decay = config["regs"][0]
    ...
    def load_pretrain_weights(self):
        ...
        self.model.user_embedding.weight.data = ua_embeddings.data
        self.model.item_embedding.weight.data = ia_embeddings.data
